...
import { useBorrowingSentinelEstimatedRevenues } from '../../../hooks/use-fees-manager'
...
const BorrowingSentinelRevenuesChart = () => {
  const theme = useContext(ThemeContext)
  const { revenues, startEpoch, endEpoch } = useBorrowingSentinelEstimatedRevenues()
...
export default BorrowingSentinelRevenuesChart
